      ...
      <div className="bg-[#F7F7F7] shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            {/* ✅ Public folder image (no /public in path) */}
            <img src="/logo.png.svg" alt="Logo" style={{ width: "150px" }} />
      ...
      <div className="bg-teal-600 py-4 flex justify-center">
        <div className="relative w-full max-w-3xl">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center">
            <svg className="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" 
                d="M12.9 14.32a8 8 0 111.414-1.414l4.387 4.387
                a1 1 0 01-1.414 1.414l-4.387-4.387zM14 8a6 6 
          ...
          <input
            ...
            className="w-full pl-14 pr-4 py-2 bg-white text-gray-700 
              placeholder-gray-400 focus:outline-none focus:ring-2 
              focus:ring-white/30 rounded-md"
          />
        </div>

        {/* ✅ Whatsapp icon from public */}
        <div className="text-amber-300 ml-7">
          <img src="/whatsapp.png.png" alt="Whatsapp" style={{ width: "30px" }} />
        </div>
      </div>
    </div>
  );
